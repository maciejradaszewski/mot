 ...
 * accessible by this->resourcesOnGovUkHelper() in any *.phtml file
 */
class ResourcesOnGovUkHelper extends AbstractHtmlElement
{
    const PAGE_TITLE_INDEX_ACTION = 'Resources on GOV.UK';

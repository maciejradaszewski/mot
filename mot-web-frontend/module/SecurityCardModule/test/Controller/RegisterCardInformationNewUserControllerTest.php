...
class RegisterCardInformationNewUserControllerTest extends AbstractLightWebControllerTest
{
    ...
    public function testUserIdFromParamsNullCauses404()
    {
        ...
        $this->getController()->registerCardInformationNewUserAction();
    }
    ...
    private function buildController()
    {
        ...
        $controller = new RegisterCardInformationNewUserController(
            $this->request,
            $this->response,

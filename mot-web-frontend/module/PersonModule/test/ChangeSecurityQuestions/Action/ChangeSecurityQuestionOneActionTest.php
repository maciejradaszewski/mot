...
class ChangeSecurityQuestionOneActionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @var ChangeSecurityQuestionForm $form */
    private $form;
    ...
    public function testWhenPost_notAllowedOnStep_shouldRedirectToStartOfJourney()
    {
        ...
        $this->assertInstanceOf(RedirectToRoute::class, $actionResult);
        $this->assertSame(ChangeSecurityQuestionsController::ROUTE, $actionResult->getRouteName());
    }
    ...
    public function mockIsAllowedOnStep($allowed)
    {
        $this->changeSecurityQuestionsStepService
            ...
            ->with(ChangeSecurityQuestionsStepService::QUESTION_ONE_STEP)
            ->willReturn($allowed);
    }
    ...
    {
        $action = new ChangeSecurityQuestionOneAction(
            $this->changeSecurityQuestionsService,
            $this->changeSecurityQuestionsStepService
        );

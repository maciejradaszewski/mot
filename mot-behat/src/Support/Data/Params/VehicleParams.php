...
class VehicleParams
{
    ...
    const WEIGHT = 'weight';
    const WEIGHT_SOURCE = 'weightSource';

    const WEIGHT_VALUE = 1000;
    const WEIGHT_SOURCE_VALUE = 'VSI';
    const WEIGHT_SOURCE_VALUE_ID = 1;
    ...
    public static function getDefaultParams()
    {
        ...
        return [
            ...
            self::WEIGHT => self::WEIGHT_VALUE,
            self::WEIGHT_SOURCE => self::WEIGHT_SOURCE_VALUE_ID,
        ];
    }
}

...
Feature: Stats Component Fail Rate
  ...
  Scenario: Get the tester performance statistics for the last month
    ...
    And I should be able to see component fail rate statistics performed "1" months ago at site "Fast cars garage" for tester "Kowalsky" and group "A"
    ...
    But none of the statistics should include advisory RFRs

Feature: MOT Test
  ...
  @brake-test
  Scenario Outline: As a tester I require the ability to perform Roller test on class 1 & 2 vehicles
  ...
  @brake-test
  Scenario Outline: As a tester I require the ability to perform Plate test on class 1 & 2 vehicles
    Given I am logged in as a Tester
    And I start an Mot Test with a Class 1 Vehicle
    And the Tester adds an Odometer Reading of 1000 mi
  ...
  Scenario Outline: As a tester I require the ability to perform Floor test on class 1 & 2 vehicles
    ...
    Examples:
      ...
      |class1.floor.valid.allLocks  |true           |true          |PASSED      |
      |class1.floor.valid.oneLock   |false          |false         |FAILED      |
 ...
 */
class DvlaV5ToVtrWithNoMakeIdUponMotTestCreation
{
    ...
    private $vehicleMakeText;
    private $dvlaVehicleMakeText;
    ...
    public function isVehicleCreated()
    {
        ...
        $this->setDvlaVehicleMakeText($dvlaVehicle['makeInFull']);
        ...
        $this->setVehicleMakeText($vtrVehicle['freeTextMakeName']);
    ...
    public function setVehicleMakeText($vehicleMakeText)
    {
        $this->vehicleMakeText = $vehicleMakeText;
    }

    public function setDvlaVehicleMakeText($dvlaVehicleMakeText)
    {
        $this->dvlaVehicleMakeText = $dvlaVehicleMakeText;
    }

    public function vehicleMakeText()
    {
        return $this->vehicleMakeText;
    }

    public function dvlaVehicleMakeText()
    {
        return $this->dvlaVehicleMakeText;
    }

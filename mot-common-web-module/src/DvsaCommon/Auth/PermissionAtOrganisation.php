...
class PermissionAtOrganisation
{
    ...
    const SLOTS_PURCHASE_CARD = 'SLOTS-PURCHASE-CARD';
    const SLOTS_PURCHASE_CARD_NOT_PRESENT = 'SLOTS-PURCHASE-CARD-NOT-PRESENT';
    ...
    const AE_SITE_LINK = 'AE-SITE-LINK';
    const AE_SITE_UNLINK = 'AE-SITE-UNLINK';
    const AE_USERNAME_VIEW = 'AE-USERNAME-VIEW';
    const AE_UPDATE_REGISTERED_OFFICE_ADDRESS = 'AE-UPDATE-REGISTERED-OFFICE-ADDRESS';
    const AE_UPDATE_REGISTERED_OFFICE_EMAIL = 'AE-UPDATE-REGISTERED-OFFICE-EMAIL';
    const AE_UPDATE_REGISTERED_OFFICE_PHONE = 'AE-UPDATE-REGISTERED-OFFICE-PHONE';
    const AE_UPDATE_CORRESPONDENCE_ADDRESS = 'AE-UPDATE-CORRESPONDENCE-ADDRESS';
    const AE_UPDATE_CORRESPONDENCE_EMAIL = 'AE-UPDATE-CORRESPONDENCE-EMAIL';
    const AE_UPDATE_CORRESPONDENCE_PHONE = 'AE-UPDATE-CORRESPONDENCE-PHONE';
    const AE_UPDATE_NAME = 'AE-UPDATE-NAME';
    const AE_UPDATE_TRADING_NAME = 'AE-UPDATE-TRADING-NAME';
    ...
    public static function all()
    {
        return [
            ...
            self::SLOTS_PURCHASE,
            self::SLOTS_PURCHASE_CARD,
            self::SLOTS_PURCHASE_CARD_NOT_PRESENT,
            ...
            self::AE_UPDATE_REGISTERED_OFFICE_ADDRESS,
            self::AE_UPDATE_REGISTERED_OFFICE_EMAIL,
            self::AE_UPDATE_REGISTERED_OFFICE_PHONE,
            self::AE_UPDATE_CORRESPONDENCE_ADDRESS,
            self::AE_UPDATE_CORRESPONDENCE_EMAIL,
            self::AE_UPDATE_CORRESPONDENCE_PHONE,
            self::AE_UPDATE_NAME,
            self::AE_UPDATE_TRADING_NAME,
            self::AE_UPDATE_TYPE,

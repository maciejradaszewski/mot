...
class CreateVehicleErrors
{
    ...
    //
    const COUNTRY_EMPTY = 'choose a country';

    const DATE_EMPTY = 'enter a date';
    const DATE_INVALID = 'enter a valid date. For example, 31 01 2014.';
    const DATE_MIN = 'must not be before %d';
    const DATE_MAX = 'must not be in the future';

    const MAKE_EMPTY = 'choose a manufacturer';
    const MAKE_OTHER_EMPTY = 'enter a manufacturer';
    ...
    const TRANSMISSION_EMPTY = 'choose a transmission';

    //
    const BOTH_REG_AND_VIN_EMPTY  = ' enter a registration mark or a VIN';

    const REG_EMPTY = 'enter a registration mark or choose a reason for not supplying one';
    ...
    const EMPTY_REG_REASON_REQUIRED   = 'choose a reason or enter a VIN or chassis number';
    ...
    const VIN_EMPTY = 'enter a full VIN or chassis number or choose a reason for not supplying one';
    ...
    const EMPTY_VIN_REASON_REQUIRED = 'choose a reason';
    ...
    const COLOUR_EMPTY = 'choose a primary colour';

    const FUEL_TYPE_EMPTY = 'choose a fuel type';

    const MODEL_EMPTY = 'choose a model';
    const MODEL_OTHER_EMPTY = 'enter a model';

...
return [
    'view_manager' => [
        'template_map'        => [
            ...
            'dateForm'                            => __DIR__ . '/../view/partials/form/date-form.phtml',
            'dateFilter'                          => __DIR__ . '/../view/partials/form/date-filter.phtml',
            'dateRangeList'                       => __DIR__ . '/../view/partials/form/date-range-list.phtml',
            'dateFromTo'                          => __DIR__ . '/../view/partials/form/date-from-to.phtml',
            'dateGroup'                           => __DIR__ . '/../view/partials/form/date-group.phtml',
            'dateGroupFormElement'                => __DIR__ . '/../view/partials/form/date-group-form-element.phtml',

...
class VehicleTestingStationUrlBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test()
    {
        ...
        $this->assertEquals(
            $urlVtsPart . '/' . self::VTS_ID .  '/testing-facilities',
            $urlBuilder::updateTestingFacilities(self::VTS_ID)
        );
        $this->assertEquals(
        ...
        $this->assertEquals(
            ...
            $urlBuilder::updateSiteAssessment(self::VTS_ID)
        );
        $this->assertEquals(
            $urlVtsPart . '/' . self::VTS_ID .  '/risk-assessment/validate',
            $urlBuilder::validateSiteAssessment(self::VTS_ID)
        );
    }
}

...
upgrade_files+=('2016-03-10-BL-1634-2fa-schema-STORY.sql');
upgrade_files+=('2016-03-11-BL-1634-inserts-STORY.sql');
upgrade_files+=('2016-03-12-BL-1346-log-in-after-activation-STORY.sql');
upgrade_files+=('2016-04-27-BL-1963-display-security-card-panel-STORY.sql');
upgrade_files+=('2016-05-11-BL-2182-order-card-permission-STORY.sql');
upgrade_files+=('2016-06-24-BL-2195-1-securely-send-requests-for-new-cards-to-swansea-STORY.sql');

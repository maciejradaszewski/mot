...
upgrade_files+=('2016-11-10-BL-4061-duplicate-certificate-permissions-STORY.sql');
upgrade_files+=('2016-11-03-BL-3883-add-more-roles-to-certificate-search-permission-STORY.sql');

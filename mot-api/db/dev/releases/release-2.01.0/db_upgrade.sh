...
upgrade_files+=('2016-05-06-BL-2196-site-test-quality-permission-STORY.sql');
upgrade_files+=('2016-06-07-BL-1592-add-missing-rfr-vehicle-class-map-entries.sql');
upgrade_files+=('2016-06-29-BL-1592-update-text-on-not-tested-rfrs-displayed-on-certificates');

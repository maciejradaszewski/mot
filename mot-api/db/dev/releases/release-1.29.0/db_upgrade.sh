...
upgradefiles+=('2016-03-18-BL-806-allocate-special-notice-number-when-it-is-published.sql');
upgradefiles+=('2016-03-30-BL-1860-remove-jasper-documents-created-since-1.28-BUG.sql');

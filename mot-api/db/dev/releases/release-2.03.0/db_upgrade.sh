...
upgrade_files+=('2016-07-08-BL-1238-create-qualification-annual-certificate-table-STORY.sql');
upgrade_files+=('2016-07-12-BL-1238-annual-certificate-permissions-STORY.sql');
upgrade_files+=('2016-07-13-BL-1238-create-annual-exam-record-event-type-STORY.sql');
upgrade_files+=('2016-07-25-BL-2852-annual-certificate-permissions-STORY.sql');
upgrade_files+=('2016-07-25-BL-2852-create-annual-exam-record-event-type-STORY.sql');
upgrade_files+=('2016-07-26-BL-2955-annual-certificate-remove-permissions-STORY.sql');
upgrade_files+=('2016-07-28-BL-2955-annual-certificate-remove-event-type-STORY.sql');

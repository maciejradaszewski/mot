...
namespace Dvsa\Mot\Api\StatisticsApi\TesterPerformance\Site\Storage;
...
class SiteTesterPerformanceStatisticsStorage
{
    ...
    public function get($siteId, $year, $month)
    {
        ...
        return $this->storage->getAsDto($key, TesterPerformanceResult::class);
    }
     ...
     * @param $year
     * @param $month
     * @param TesterPerformanceResult[] $data
     * @throw S3Exception
     */

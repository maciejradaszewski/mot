<?php
namespace Dvsa\Mot\Api\StatisticsApi\TesterPerformance\National\Repository;

use Doctrine\ORM\Query\ResultSetMapping;
use Dvsa\Mot\Api\StatisticsApi\TesterPerformance\National\QueryBuilder\NationalComponentBreakdownQueryBuilder;

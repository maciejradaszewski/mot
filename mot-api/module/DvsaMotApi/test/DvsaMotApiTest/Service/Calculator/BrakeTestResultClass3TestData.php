                ...
                ['desc'   => 'RxRxR, Test pass on efficiencies class 3',
                 'input'  => [
                     ...
                     'serviceBrake1Test' => [
                         ...
                         'axle1'  =>
                             ['efforts' => ['near' => 70, 'off' => 75]],
                         'single' =>
                             ['effort' => 65, 'lock' => false],
                     ],
                     'serviceBrake2Test' => [
                         'type'   => BrakeTestTypeCode::ROLLER,
                         'axle1'  =>
                             ['efforts' => ['near' => 68, 'off' => 72]],
                         'single' =>
                             ['effort' => 70, 'lock' => false],
                     ],
                     'parkingBrakeTest'  =>
                         ['type'    => BrakeTestTypeCode::ROLLER,
                ...
                ['desc'   => 'RxRxR, Test pass on locks class 3, fails on parking brake',
                 'input'  => [
                     ...
                     'serviceBrake1Test' => [
                         'type'   => BrakeTestTypeCode::ROLLER,
                         'axle1'  =>
                             ['efforts' => ['near' => 30, 'off' => 30], 'locks' => ['off']],
                         'single' =>
                             ['effort' => 40, 'lock' => true],
                     ],
                     'serviceBrake2Test' => [
                         'type'   => BrakeTestTypeCode::ROLLER,
                         'axle1'  =>
                             ['efforts' => ['near' => 30, 'off' => 30], 'locks' => ['near', 'off']],
                         'single' =>
                             ['effort' => 30, 'lock' => false],
                     ],
                     'parkingBrakeTest'  =>
                         ['type'    => BrakeTestTypeCode::ROLLER,
                ...
                ['desc'   => 'RxRxR, Test pass on efficiencies class 3',
                 'input'  => [
                     ...
                     'serviceBrake1Test' => [
                         'type'   => BrakeTestTypeCode::ROLLER,
                         'axle1'  =>
                             ['efforts' => ['near' => 30, 'off' => 40]],
                         'single' =>
                             ['effort' => 55, 'lock' => false],
                     ],
                     'serviceBrake2Test' => [
                         'type'   => BrakeTestTypeCode::ROLLER,
                         'axle1'  =>
                 ...
                 'input'  => [
                     ...
                     'serviceBrake1Test' => [
                         ...
                         'axle2'  =>
                             ['efforts' => ['near' => 40, 'off' => 40]],
                         'single' =>
                             ['effort' => 40, 'lock' => false],
                     ],
                     'serviceBrake2Test' => [
                         'type'   => BrakeTestTypeCode::ROLLER,
                         'axle2'  =>
                             ['efforts' => ['near' => 20, 'off' => 50]],
                         'single' =>
                             ['effort' => 76, 'lock' => false],
                     ],
                     'parkingBrakeTest'  =>
                         ['type'    => BrakeTestTypeCode::ROLLER,
                          'efforts' => ['near' => 40, 'off' => 40]]
            ...
            [['desc'   => 'RxR, Test pass on efficiencies class 3 before 1968',
              'input'  => [
                  ...
                  'serviceBrake1Test' => [
                      'type'   => BrakeTestTypeCode::ROLLER,
                      'axle1'  =>
                          ['efforts' => ['near' => 133, 'off' => 133]],
                      'single' =>
                          ['effort' => 134, 'lock' => false],
                  ],
                  'parkingBrakeTest'  =>
                      ['type'    => BrakeTestTypeCode::ROLLER,
                       'efforts' => ['near' => 150, 'off' => 150]]

...
class MotTestFailureMapperTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function testMapDataForFailure($data, $additionalData, $isDualLanguage, $isNormalTest = false, $expected)
    {
...
002 Failed Pos1 pos2 pos3 (Some 2 comment) [1.1.2]',
            ...
            [
                ...
                [
                    ...
                    'InspectionAuthority'    => "Some Garage\nABC Street\nSome Place\nTown\t\t011712013243\n",
                    'FailureInformation'     =>
                        '001 Failed Pos1 pos2 pos3 (Some 1 comment) [1.1.12]' . PHP_EOL .
            ...
            [
                ...
                [
                    ...
                    'InspectionAuthority'    => "Some Garage\nABC Street\nSome Place\nTown\t\t011712013243\n",
                    'FailureInformation'     =>
                        '001 Failed Pos1 pos2 pos3 (Some comment) [1.1.1] * DANGEROUS *' . PHP_EOL .
            ...
            [
                ...
                [
                    ...
                    'InspectionAuthority'    => "Some Garage\nABC Street\nSome Place\nTown\t\t011712013243\n",
                    'FailureInformation'     =>
                        '001 Failed Pos1 pos2 pos3 (Some comment2) [1.1.1] * DANGEROUS *' . PHP_EOL .
                        '001 Failed Cy Pos1 pos2 pos3 (Some comment2) [1.1.1] * PERYGLUS *',
                    'AdvisoryInformation'    =>
                        '002 Pos1 pos2 pos3 (Some comment)' . PHP_EOL .
            ...
            [
                ...
                [
                    ...
                    'AdvisoryInformation'    =>
                        '004 Pos1 pos2 pos3 (Some comment)'  . PHP_EOL .

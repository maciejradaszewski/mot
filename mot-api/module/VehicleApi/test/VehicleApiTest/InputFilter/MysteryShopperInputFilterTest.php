...
class MysteryShopperInputFilterTest extends \PHPUnit_Framework_TestCase
{
        ...
        return [
            [
                [
                    ...
                    MysteryShopperInputFilter::FIELD_START_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_VALID_START_IN, true),
                    MysteryShopperInputFilter::FIELD_END_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_VALID_END_IN, true),
                    MysteryShopperInputFilter::FIELD_TEST_DATE => $this->constructDateFromNow('-1 year', true),
                    MysteryShopperInputFilter::FIELD_EXPIRY_DATE => $this->constructDateFromNow('-1 week', true),
                ],
                true,
                '',
            ],
            ...
            [
                ...
                [
                    ...
                    MysteryShopperInputFilter::FIELD_CAMPAIGN_DATES => [
                        CampaignDateValidator::LAST_TEST_IN_FUTURE => $this->getMessageFromValidatorTemplate(CampaignDateValidator::LAST_TEST_IN_FUTURE),
                    ],
                ],
            ],
            [
            ...
            [
                [
                    MysteryShopperInputFilter::FIELD_VEHICLE_ID => '1',
                    MysteryShopperInputFilter::FIELD_SITE_NUMBER => 'VTS1234',
                    MysteryShopperInputFilter::FIELD_START_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_START_IN_PAST, true),
                    MysteryShopperInputFilter::FIELD_END_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_VALID_START_IN, true),
                    MysteryShopperInputFilter::FIELD_TEST_DATE => $this->constructDateFromNow('-1 year', true),
                    MysteryShopperInputFilter::FIELD_EXPIRY_DATE => $this->constructDateFromNow('-1 week', true),
                ],
                false,
                [
                    MysteryShopperInputFilter::FIELD_CAMPAIGN_DATES => [
                        CampaignDateValidator::IS_IN_THE_PAST => $this->getMessageFromValidatorTemplate(CampaignDateValidator::IS_IN_THE_PAST),
                    ],
                ],
            ],
            [
                [
                    MysteryShopperInputFilter::FIELD_VEHICLE_ID => '1',
                    MysteryShopperInputFilter::FIELD_SITE_NUMBER => 'VTS1234',
                    MysteryShopperInputFilter::FIELD_START_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_VALID_END_IN, true),
                    MysteryShopperInputFilter::FIELD_END_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_VALID_START_IN, true),
                    MysteryShopperInputFilter::FIELD_TEST_DATE => $this->constructDateFromNow('-1 year', true),
                    MysteryShopperInputFilter::FIELD_EXPIRY_DATE => $this->constructDateFromNow('-1 week', true),
                ],
                ...
                [
                    MysteryShopperInputFilter::FIELD_CAMPAIGN_DATES => [
                        CampaignDateValidator::END_BEFORE_START => $this->getMessageFromValidatorTemplate(CampaignDateValidator::END_BEFORE_START),
                    ],
                ],
            ],
            [
                [
                    ...
                    MysteryShopperInputFilter::FIELD_SITE_NUMBER => 'VTS1234',
                    MysteryShopperInputFilter::FIELD_START_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_VALID_START_IN, true),
                    MysteryShopperInputFilter::FIELD_END_DATE => $this->constructDateFromNow('+32 days', true),
                    MysteryShopperInputFilter::FIELD_TEST_DATE => $this->constructDateFromNow('-1 year', true),
                    MysteryShopperInputFilter::FIELD_EXPIRY_DATE => $this->constructDateFromNow('-1 week', true),
                ],
                false,
                [
                    MysteryShopperInputFilter::FIELD_CAMPAIGN_DATES => [
                        CampaignDateValidator::COLLIDING_END_DATE => $this->getMessageFromValidatorTemplate(CampaignDateValidator::COLLIDING_END_DATE),
                    ],
                ],
            ],
            [
                [
                    MysteryShopperInputFilter::FIELD_VEHICLE_ID => 1,
                    MysteryShopperInputFilter::FIELD_SITE_NUMBER => 'VTS1234',
                    MysteryShopperInputFilter::FIELD_START_DATE => $this->constructDateFromNow('+12 days', true),
                    MysteryShopperInputFilter::FIELD_END_DATE => $this->constructDateFromNow(self::NEW_CAMPAIGN_VALID_END_IN, true),
                    MysteryShopperInputFilter::FIELD_TEST_DATE => $this->constructDateFromNow('-1 year', true),
                    MysteryShopperInputFilter::FIELD_EXPIRY_DATE => $this->constructDateFromNow('-1 week', true),
                ],
                ...
                [
                    MysteryShopperInputFilter::FIELD_CAMPAIGN_DATES => [
                        CampaignDateValidator::COLLIDING_START_DATE => $this->getMessageFromValidatorTemplate(CampaignDateValidator::COLLIDING_START_DATE),
                    ],
                ],
            ],
            [
                [
                    MysteryShopperInputFilter::FIELD_VEHICLE_ID => 1,
                    MysteryShopperInputFilter::FIELD_SITE_NUMBER => 'VTS1234',
                    MysteryShopperInputFilter::FIELD_START_DATE => $this->constructDateFromNow('+11 days', true),
                    MysteryShopperInputFilter::FIELD_END_DATE => $this->constructDateFromNow('+16 days', true),
                    MysteryShopperInputFilter::FIELD_TEST_DATE => $this->constructDateFromNow('-1 year', true),
                    MysteryShopperInputFilter::FIELD_EXPIRY_DATE => $this->constructDateFromNow('-1 week', true),
                ],
                false,
            ...
            [
                [
                    MysteryShopperInputFilter::FIELD_VEHICLE_ID => 1,
                    MysteryShopperInputFilter::FIELD_SITE_NUMBER => 'VTS1234',
                    MysteryShopperInputFilter::FIELD_START_DATE => $this->constructDateFromNow('+9 days', true),
                    MysteryShopperInputFilter::FIELD_END_DATE => $this->constructDateFromNow('+18 days', true),
                    MysteryShopperInputFilter::FIELD_TEST_DATE => $this->constructDateFromNow('-1 year', true),
                    MysteryShopperInputFilter::FIELD_EXPIRY_DATE => $this->constructDateFromNow('-1 week', true),
                ],
                false,
                [
                    MysteryShopperInputFilter::FIELD_CAMPAIGN_DATES => [
                        CampaignDateValidator::COVERING_ANOTHER_CAMPAIGN => $this->getMessageFromValidatorTemplate(CampaignDateValidator::COVERING_ANOTHER_CAMPAIGN),
                    ],
                ],
            ],
        ];
     ...
     * @param bool   $toString to convert the datetime to string
     *
     * @return \DateTime
     */

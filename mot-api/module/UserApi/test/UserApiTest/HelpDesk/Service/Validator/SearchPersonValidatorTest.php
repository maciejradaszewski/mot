...
class SearchPersonValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $model = new SearchPersonModel('username', null, null, null, null, null);
        (new SearchPersonValidator())->validate($model);
    }

    public function testFirstNameNotEmpty()
    {
        $model = new SearchPersonModel(null, 'First name', null, null, null, null);
        (new SearchPersonValidator())->validate($model);
    }

    public function testLastNameNotEmpty()
    {
        $model = new SearchPersonModel(null, null, 'Last name', null, null, null);
        (new SearchPersonValidator())->validate($model);
    }

    public function testDateOfBirthNotEmpty()
    {
        $model = new SearchPersonModel(null, null, null, '1980-10-10', null, null);
        (new SearchPersonValidator())->validate($model);
    }
    ...
    {
        $model = new SearchPersonModel(null, null, null, '2000-03-1x', null, null);
        (new SearchPersonValidator())->validate($model);
    }
    ...
    {
        $model = new SearchPersonModel(null, null, null, '2100-03-10', null, null);
        (new SearchPersonValidator())->validate($model);
    }

    public function testPostcodeNotEmpty()
    {
        $model = new SearchPersonModel(null, null, null, null, null, 'CM3 7YH');
        (new SearchPersonValidator())->validate($model);
    }

    public function testAllFieldsNotEmpty()
    {
        $model = new SearchPersonModel('username', 'First name', 'Last name', '1970-12-12', 'Stoke Gifford', 'CM3 7YH');
        (new SearchPersonValidator())->validate($model);
    }
    ...
    {
        $model = new SearchPersonModel(null, null, null, null, null, null);
        (new SearchPersonValidator())->validate($model);
    }
    ...
    {
        $model = new SearchPersonModel(0, 0, 0, 0, 0, 0);
        (new SearchPersonValidator())->validate($model);
    }
    ...
    {
        $model = new SearchPersonModel(false, false, false, false, false, false);
        (new SearchPersonValidator())->validate($model);
    }
}

	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String baseDN_tLDAPOutput_1 = "dc=mot,dc=gov,dc=uk";
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 4) {
							...
							if (rs_tMysqlInput_1.getObject(4) != null) {
								row1.title_id = rs_tMysqlInput_1.getInt(4);
							} else {
								row1.title_id = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 9) {
							...
							if (rs_tMysqlInput_1.getObject(9) != null) {
								row1.gender_id = rs_tMysqlInput_1.getInt(9);
							} else {
								row1.gender_id = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 15) {
							...
							if (rs_tMysqlInput_1.getObject(15) != null) {
								row1.created_by = rs_tMysqlInput_1.getLong(15);
							} else {
						...
						if (colQtyInRs_tMysqlInput_1 < 18) {
							...
							if (rs_tMysqlInput_1.getObject(18) != null) {
								row1.version = rs_tMysqlInput_1.getInt(18);
							} else {
						...
						{ // start of Var scope
							...
							OpenDJ_tmp.employeeNumber = row1.mot_one_user_id;
							...
							OpenDJ_tmp.userPassword = "Password1";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = userSync.class.getClassLoader()
					.getResourceAsStream(
							"mot2/usersync_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 161161 characters generated by Talend Open Studio for Data Integration on the
 * December 11, 2014 4:41:56 PM GMT
 ************************************************************************************************/

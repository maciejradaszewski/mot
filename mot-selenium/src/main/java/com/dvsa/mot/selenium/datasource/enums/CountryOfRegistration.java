...
public enum CountryOfRegistration {
    ...
    private final String countryOfRegistrationID;
    private final String countryOfRegistrationCode;

    private CountryOfRegistration(String countryOfRegistration, String countryOfRegistrationID, String countryOfRegistrationCode) {

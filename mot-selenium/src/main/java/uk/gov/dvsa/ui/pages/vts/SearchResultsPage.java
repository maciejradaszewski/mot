...
public class SearchResultsPage extends Page  {
    ...
    public SearchResultsPage(MotAppDriver driver) {
        super(driver);
        selfVerify();
    }
    ...
    public String getVtsStatus(int resultPosition) {
        return getResultsList().get(resultPosition).findElements(By.tagName("td"))
                .get(4).findElement(By.tagName("span")).getText();
    }

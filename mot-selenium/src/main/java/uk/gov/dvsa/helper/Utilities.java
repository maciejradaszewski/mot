...
public class Utilities {
    ...
    public static void takeScreenShot(WebDriver driver, String filename, String destinationPath) {
        try {
            ...
            if (!screenshotFile.exists()) {
                ...
                com.dvsa.mot.selenium.framework.Utilities.Logger
                        .LogInfo("Screenshot saved to: " + screenshotFile.getAbsolutePath());
            }
        } catch (Exception e) {
            com.dvsa.mot.selenium.framework.Utilities.Logger.LogError("Error trying to take screen shot: " + e.getMessage(), e);
        }
    }
    ...
    public static void copyUrlBytesToFile(String pdfUrl, WebDriver driver, String pathNFileName) throws IOException{
        ...
        try {
            downloadedFile = com.dvsa.mot.selenium.framework.Utilities.getUrl(pdfUrl, driver);
        } catch (Exception e) {

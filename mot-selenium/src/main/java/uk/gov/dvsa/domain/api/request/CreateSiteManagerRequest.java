...
public class CreateSiteManagerRequest extends UserRequest {

    private List<Integer> siteIds;
    private String testGroup;

    public CreateSiteManagerRequest(List<Integer> siteIdList, boolean accountClaimRequired, TestGroup testGroup) {
